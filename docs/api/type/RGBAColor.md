# <def>Box3RGBAColor</def> / <def>GameRGBAColor</def>
...
## 构造函数
new <def>Box3RGBAColor</def>(r: <def>number</def>, g: <def>number</def>, b: <def>number</def>, a: <def>number</def>): <def>Box3RGBAColor</def>  
new <def>GameRGBAColor</def>(r: <def>number</def>, g: <def>number</def>, b: <def>number</def>, a: <def>number</def>): <def>GameRGBAColor</def>  
??? example "示例"
    === "旧版编辑器"
        ```javascript
...
<span anchor="set"><method>set</method> (r: <def>number</def>, g: <def>number</def>, b: <def>number</def>, a: <def>number</def>): <def>Box3RGBAColor</def>  
<method>set</method> (r: <def>number</def>, g: <def>number</def>, b: <def>number</def>, a: <def>number</def>): <def>GameRGBAColor</def></span>  
: 设置RGB颜色的值
??? example "示例"
    === "旧版编辑器"
        ```javascript
...
<span anchor="copy"><method>copy</method> (c: <def>Box3RGBAColor</def>): <def>Box3RGBAColor</def>  
<method>copy</method> (c: <def>GameRGBAColor</def>): <def>GameRGBAColor</def></span>  
...
<method>add</method> (rgba: <def>Box3RGBAColor</def>): <def>Box3RGBAColor</def>  
<method>add</method> (rgba: <def>GameRGBAColor</def>): <def>GameRGBAColor</def>
...
<method>sub</method> (rgba: <def>Box3RGBAColor</def>): <def>Box3RGBAColor</def>  
<method>sub</method> (rgba: <def>GameRGBAColor</def>): <def>GameRGBAColor</def>
...
<method>mul</method> (rgba: <def>Box3RGBAColor</def>): <def>Box3RGBAColor</def>  
<method>mul</method> (rgba: <def>GameRGBAColor</def>): <def>GameRGBAColor</def>
...
<method>div</method> (rgba: <def>Box3RGBAColor</def>): <def>Box3RGBAColor</def>  
<method>div</method> (rgba: <def>GameRGBAColor</def>): <def>GameRGBAColor</def>
...
<hiddenMethod>addEq</hiddenMethod> (rgba: <def>Box3RGBAColor</def>): <def>Box3RGBAColor</def>  
<hiddenMethod>addEq</hiddenMethod> (rgba: <def>GameRGBAColor</def>): <def>GameRGBAColor</def>
...
<hiddenMethod>subEq</hiddenMethod> (rgba: <def>Box3RGBAColor</def>): <def>Box3RGBAColor</def>  
<hiddenMethod>subEq</hiddenMethod> (rgba: <def>GameRGBAColor</def>): <def>GameRGBAColor</def>
...
<hiddenMethod>mulEq</hiddenMethod> (rgba: <def>Box3RGBAColor</def>): <def>Box3RGBAColor</def>  
<hiddenMethod>mulEq</hiddenMethod> (rgba: <def>GameRGBAColor</def>): <def>GameRGBAColor</def>
...
<hiddenMethod>divEq</hiddenMethod> (rgba: <def>Box3RGBAColor</def>): <def>Box3RGBAColor</def>  
<hiddenMethod>divEq</hiddenMethod> (rgba: <def>GameRGBAColor</def>): <def>GameRGBAColor</def>
...
<method>lerp</method> (rgba: <def>Box3RGBAColor</def>, n: <def>number</def>): <def>Box3RGBAColor</def>  
<method>lerp</method> (rgba: <def>GameRGBAColor</def>, n: <def>number</def>): <def>GameRGBAColor</def>
...
??? example "示例"
    ...
    === "Arena 编辑器"
        ...
        ```
<hiddenMethod>blendEq</hiddenMethod> (rgb: <def>Box3RGBColor</def>): <def>Box3RGBColor</def>  
<hiddenMethod>blendEq</hiddenMethod> (rgb: <def>GameRGBColor</def>): <def>GameRGBColor</def>
...
<method>equals</method> (rgba: <def>Box3RGBAColor</def>): <def>boolean</def>
<method>equals</method> (rgba: <def>GameRGBAColor</def>): <def>boolean</def>
